    ...
    <div className="space-y-5 md:flex w-[83%] mx-auto mt-10 ">
      <div className="w-[83%] mx-auto mt-15 ">
        ...
        <div className="flex gap-5 mt-4">
          <button className="rounded-2xl bg-linear-to-r from-[#4F39F6] to-[#9514FA] px-3 py-1 text-white ">
            <p>Explore Products</p>
          </button>
          <button className="flex justify-center items-center gap-2 rounded-2xl  btn btn-outline bg-linear-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent px-3 py-1 border-2 border-[#4F39F6]">
            {" "}
